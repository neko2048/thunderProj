...
if __name__ == "__main__":
    ...
    config = Config({
        ...
        "freqMap": "%(home)sdat/freqmeanMap_1hr.npy"
        })
    ...
    percentileFunc = { # key for lower bound
        ...
        40: lambda x:  0.047 * x + 1.167, 
        50: lambda x:  0.094 * x + 1.028, 
        60: lambda x:  0.049 * x + 1.432, 
        70: lambda x:  0.045 * x + 1.420, 
        80: lambda x: -0.009 * x + 2.043, 
        90: lambda x: -0.009 * x + 2.043, 
    }
    ...
    np.save("percentileMapYTJHU.npy", percentileMap)
    existDateOpt = []
    existDateEndOpt = []
    ...
    np.save("accumThd-{}-{}.npy".format(caseType, methodName), accumThd)
    ...
    plt.savefig("{}Map-{}.jpg".format(caseType, methodName), dpi=250)
    plt.clf()
