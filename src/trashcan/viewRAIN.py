...
class DrawSys(object):
    ...
    def drawFreqMap(self, ncData, threshold):
        ...
        for i in range(len(time))[::8]:
            ...
            FREQ = ax.pcolormesh(xlon, xlat, var[i], cmap="rainbow", vmin=0, vmax=1e3)
            ...
            plt.title("Total Accumulative Precpitation [mm]", \
